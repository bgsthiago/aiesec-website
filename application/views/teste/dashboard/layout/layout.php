      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><span>AISEC Sorocaba</span><img src="assets/images/logo-aisec.png" width="10%"></a>
          </div>
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-edit"></i> Cadastrar <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="cadastrar-intercambista">Cadastrar Intercambista</a>
                    </li>
